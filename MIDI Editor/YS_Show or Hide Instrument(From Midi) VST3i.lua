--[[
 * ReaScript Name: Show or Hide Instrument(From Midi) VST3i
 * Version: 1.0
 * Author: YS
...
local function getInstrumentIdx(track)
  ...
  for i = num_fx,1,-1 do 
    ...
    if (name:match("VSTi") == "VSTi" or name:match("VST3i") == "VST3i") and not isFXonBlacklist(name) then idx = i-1 break end
  end
