...
while take ~= nil do
    ...
    while idx < notecnt do
        ...
        if notekey_tb[pitch] then
            ...
            StartOfMeasure = reaper.MIDI_GetPPQPos_StartOfMeasure(take,
                                                                  startppqpos)
            ...
            for i, v in ipairs(new_table) do
                ...
                if startppqpos >= selstppq and startppqpos < selendppq then
                    if notetick >= qian and notetick < hou then
                        reaper.MIDI_SetNote(take, idx, true, NULL, NULL, NULL,
