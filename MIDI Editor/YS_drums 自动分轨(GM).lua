...
if track0_midiport == -1 then
    midisend_track = reaper.GetTrackSendInfo_Value(track0, 0, 0, 'P_DESTTRACK')
    track0_midisend = reaper.GetTrackSendInfo_Value(track0, 0, 0, 'I_MIDIFLAGS')
end
...
if drums == 'E' then
    tb_kit[97] = 'TECHNO HIT'
end
if drums == 'E' then
    tb_kit[98] = 'PHILLY HIT'
end
if drums == 'E' then
    tb_kit[99] = 'SHOCK WAVE'
end
if drums == 'E' then
    tb_kit[100] = 'LO-FI RAVE'
end
if drums == 'E' then
    tb_kit[101] = 'BAM HIT'
end
...
if drums == 'E' then
    tb_kit[103] = 'TAPE REWIND'
end
if drums == 'E' then
    tb_kit[104] = 'PHONO NOISE'
end
if drums == 'E' then
    tb_kit[126] = 'VOICE TAH'
end
if drums == 'E' then
    tb_kit[127] = 'SLAPPY'
end
if drums == 'J' or drums == 'BR' then
    tb_kit[100] = 'BRUSH TAP'
end
if drums == 'J' or drums == 'BR' then
    tb_kit[101] = 'BRUSH TAP'
end
if drums == 'J' or drums == 'BR' then
    tb_kit[102] = 'BRUSH SLAP'
end
if drums == 'J' or drums == 'BR' then
    tb_kit[103] = 'BRUSH SLAP'
end
if drums == 'J' or drums == 'BR' then
    tb_kit[104] = 'BRUSH SLAP'
end
if drums == 'J' or drums == 'BR' then
    tb_kit[105] = 'BRUSH SWIRL'
end
if drums == 'J' or drums == 'BR' then
    tb_kit[106] = 'BRUSH SWIRL'
end
if drums == 'J' or drums == 'BR' then
    tb_kit[107] = 'BRUSH SWIRL'
end
if drums == 'BR' then
    tb_kit[38] = 'BRUSH TAP'
end
if drums == 'BR' then
    tb_kit[39] = 'BRUSH SLAP'
end
if drums == 'BR' then
    tb_kit[40] = 'BRUSH SWIRL'
end
...
for i, v in ipairs(tbkey3) do
    ...
    if track0_midiport ~= -1 then
        ...
        reaper.CreateTrackSend(track_new, midisend_track)
        reaper.SetTrackSendInfo_Value(track_new, 0, 0, 'I_MIDIFLAGS', track0_midisend)
        reaper.SetTrackSendInfo_Value(track_new, 0, 0, 'I_SRCCHAN', -1)
    end
...
if #cym_57_tick > 0 then
    ...
    if track_cym_midiport == -1 then
        midisend_track_cym = reaper.GetTrackSendInfo_Value(track_cym, 0, 0, 'P_DESTTRACK')
        track_cym_midisend = reaper.GetTrackSendInfo_Value(track_cym, 0, 0, 'I_MIDIFLAGS')
    end
    ...
    if #cym_49_n > 0 or #cym_52_n > 0 or #cym_55_n > 0 or #cym_57_n > 0 then
        ...
        if track_cym_midiport ~= -1 then
            ...
            reaper.CreateTrackSend(track_roll, midisend_track_cym)
            reaper.SetTrackSendInfo_Value(track_roll, 0, 0, 'I_MIDIFLAGS', track_cym_midisend)
            reaper.SetTrackSendInfo_Value(track_roll, 0, 0, 'I_SRCCHAN', -1)
        end
